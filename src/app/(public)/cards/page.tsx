...
//             // ${isSelected ? 'ring-2 ring-white/50' : 'opacity-90 hover:opacity-100'} bg-red-400`}
//         >
...
//                 <div className="absolute inset-0 p-3 md:p-4 flex flex-col justify-between text-white bg-red-400">
...
//              <Image
//                 src="/landing/nova-card-front-v.svg"
//                 fill
//                 alt="Company Logo"
//                 loading="eager"
