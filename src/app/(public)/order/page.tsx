...
const CARD_TEMPLATES: CardTemplate[] = [
    ...
    { id: 2, name: 'Maple', price: 50000, theme: 'bg-yellow-800', color: '#D4B99F', subtext: 'Natural Wood Grain' },
    { id: 3, name: 'Auric', price: 60000, theme: 'bg-gray-900', color: '#282828', subtext: 'Sleek and Minimal' },
];
