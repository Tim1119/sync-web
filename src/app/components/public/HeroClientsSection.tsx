...
const cardsData: CardData[] = [ { id: "nova-card", name: "Nova Card", price: "₦30,000", image: "/landing/nova-card-back-h.png", features: [{ text: "Durable plastic finish" },{ text: "Full-color surface printing" },{ text: "Lightweight and everyday use" }], link: "/cards/nova", imageBgColor: "bg-gradient-to-l from-[#8CA0F7] via-[#5066C9] to-[#0A2496]", }, { id: "maple-card", name: "Maple Card", price: "₦40,000", image: "/landing/maple-card-back-h.png", features: [{ text: "Premium wooden body" },{ text: "Laser-engraved details" },{ text: "Natural texture and unique finish" }], link: "/cards/maple", imageBgColor: "bg-gradient-to-l from-[#EED7B4] via-[#AFA9A0] to-[#7C7871]", }, { id: "metal-card", name: "Metal Card", price: "₦50,000", image: "/landing/metal-card-back-h.png", features: [{ text: "Solid metal construction" },{ text: "Minimal print, sleek look" },{ text: "Designed for a premium feel" }], link: "/cards/metal", imageBgColor: "bg-gradient-to-r from-[#374151] via-[#5A6A84] to-[#7C93B7]", }, ];
      ...
      */}
      <div className="relative z-20 w-full overflow-hidden pb-12 py-4"> 
        <div className="max-w-7xl mx-auto px-6 lg:px-8 ">
            ...
            <div className="relative w-full py-20 overflow-hidden border-t border-b border-white/20"> 
      ...
      {/* ==================================================
        ...
        ==================================================
      */}
      <div className="relative w-full overflow-hidden pt-12 md:pt-16 pb-24 md:pb-32"> 
