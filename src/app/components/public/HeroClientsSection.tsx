...
const cardsData: CardData[] = [ { id: "nova-card", name: "Nova Card", price: "₦35,000", image: "/landing/nova-card-back-h.png", features: [{ text: "Durable plastic finish" },{ text: "Full-color surface printing" },{ text: "Lightweight and everyday use" }], link: "/cards/nova", imageBgColor: "bg-gradient-to-l from-[#8CA0F7] via-[#5066C9] to-[#0A2496]", }, { id: "maple-card", name: "Maple Card", price: "₦50,000", image: "/landing/maple-card-back-h.png", features: [{ text: "Premium wooden body" },{ text: "Laser-engraved details" },{ text: "Natural texture and unique finish" }], link: "/cards/maple", imageBgColor: "bg-gradient-to-l from-[#EED7B4] via-[#AFA9A0] to-[#7C7871]", }, { id: "metal-card", name: "Auric Card", price: "₦60,000", image: "/landing/metal-card-back-h.png", features: [{ text: "Solid metal construction" },{ text: "Minimal print, sleek look" },{ text: "Designed for a premium feel" }], link: "/cards/metal", imageBgColor: "bg-gradient-to-r from-[#374151] via-[#5A6A84] to-[#7C93B7]", }, ];
  ...
  return (
    <motion.div
      className="relative px-4 py-2 lg:py-4 rounded-xl border border-white/10 bg-[#030C32]  overflow-hidden group 
                ...
                w-[250px] lg:w-[300px] shrink-0 md:w-auto md:max-w-md lg:max-w-none snap-center"
